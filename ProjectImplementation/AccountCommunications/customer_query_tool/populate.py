...
def populate():
    ...
    operators = [{'id':'030', 'name':'PSD Ferries','homepage':'www.psdferries.com', 'api_url':'www.psdferries.pythonanywhere.com', 
    ...
    vehicles = [{'included':'yes', 'reference':'879645', 'vehicle_type':'water ferry', 'condition':'brand new' },
                ...
                {'included':'no', 'reference':'567432', 'vehicle_type':'water bus', 'condition':'rusty and needing repairs' },
    ...
    locfroms = [{'id':1, 'lat_long':LatLong.objects.get(id=2), 'NaPTAN':'9100GLGC', 'other':'lots of cargo ships', 'other_type':'cargo ships', 'accuracy':9},
                {'id':2, 'lat_long':LatLong.objects.get(id=1), 'NaPTAN':'9100GLGF', 'other':'', 'other_type':'', 'accuracy':6},
                {'id':3, 'lat_long':LatLong.objects.get(id=3), 'NaPTAN':'9100GLGD', 'other':'', 'other_type':'', 'accuracy':3},
                {'id':4, 'lat_long':LatLong.objects.get(id=5), 'NaPTAN':'9100GLGS', 'other':'', 'other_type':'', 'accuracy':99},
                {'id':5, 'lat_long':LatLong.objects.get(id=4), 'NaPTAN':'9100GLGJ', 'other':'', 'other_type':'', 'accuracy':2},
                ]
        
    for loc in locfroms:
        add_loc_from(loc)

    loctos = [{'id':1, 'lat_long':LatLong.objects.get(id=2), 'NaPTAN':'9100GLGC', 'other':'lots of cargo ships', 'other_type':'cargo ships', 'accuracy':9},
                {'id':2, 'lat_long':LatLong.objects.get(id=1), 'NaPTAN':'9100GLGF', 'other':'', 'other_type':'', 'accuracy':6},
                {'id':3, 'lat_long':LatLong.objects.get(id=3), 'NaPTAN':'9100GLGD', 'other':'', 'other_type':'', 'accuracy':3},
                {'id':4, 'lat_long':LatLong.objects.get(id=5), 'NaPTAN':'9100GLGS', 'other':'', 'other_type':'', 'accuracy':99},
                {'id':5, 'lat_long':LatLong.objects.get(id=4), 'NaPTAN':'9100GLGJ', 'other':'', 'other_type':'', 'accuracy':2},
    ...
    locations= [{'id':1, 'lat_long':LatLong.objects.get(id=2), 'NaPTAN':'9100GLGC', 'other':'', 'other_type':'', 'accuracy':9},
                {'id':2, 'lat_long':LatLong.objects.get(id=1), 'NaPTAN':'9100GLGF', 'other':'', 'other_type':'', 'accuracy':6},
                {'id':3, 'lat_long':LatLong.objects.get(id=3), 'NaPTAN':'9100GLGD', 'other':'', 'other_type':'', 'accuracy':3},
                {'id':4, 'lat_long':LatLong.objects.get(id=5), 'NaPTAN':'9100GLGS', 'other':'', 'other_type':'', 'accuracy':99},
                {'id':5, 'lat_long':LatLong.objects.get(id=4), 'NaPTAN':'9100GLGJ', 'other':'', 'other_type':'', 'accuracy':2},
    ...
    concessions = [{'id':'700', 'customer':Customer.objects.get(customer_id=1), 'mode':Mode.objects.get(id='011'), 
                'operator':Operator.objects.get(id='030'), 'name':'family concession', 'price':Monetary_Value.objects.get(money_id=1),
                ...
                {'id':'701', 'customer':Customer.objects.get(customer_id=1), 'mode':Mode.objects.get(id='011'), 
                'operator':Operator.objects.get(id='030'), 'name':'winter sale card', 'price':Monetary_Value.objects.get(money_id=3),
                ...
                'operator':Operator.objects.get(id='030'), 'name':'summer sale card', 'price':Monetary_Value.objects.get(money_id=4),
    ...
    purchases = [{'id':'700', 'customer':Customer.objects.get(customer_id=1), 'mode':Mode.objects.get(id='012'), 
                ...
                'passenger_number':2, 'passenger_type':'two adults', 'vehicle':Vehicle.objects.get(reference='879645'),
                ...
                'passenger_number':3, 'passenger_type':'two adults, one child', 'vehicle':Vehicle.objects.get(reference='567432'),
                ...
                'passenger_number':1, 'passenger_type':'one adult', 'vehicle':Vehicle.objects.get(reference='567432'),
                ...
                'travel_class':'first', 'booking_date_time':'2020-01-07T11:33:11Z', 'transaction':Transaction.objects.get(reference='986'),
                'account_balance':AccountBalance.objects.get(account_id=5), 'agent':'PSD Buses', 
                'passenger_number':1, 'passenger_type':'one adult', 'vehicle':Vehicle.objects.get(reference='137648'),
                'route':'fast route', 'travel_from_date_time':'2021-10-27T11:33:11Z', 'travel_to_date_time':'2021-11-08T11:33:11Z',
                'conditions':'peak time', 'concession':'none', 'restrictions':'off peak only',
                'ticket':Ticket.objects.get(reference='1234D'), 'location_from':LocationFrom.objects.get(id=1),
                'location_to':LocationTo.objects.get(id=3), 'reserved_position':'1A', 'service_request':'charging'},   
                ...
                'travel_class':'first', 'booking_date_time':'2020-01-07T11:33:11Z', 'transaction':Transaction.objects.get(reference='986'),
                'account_balance':AccountBalance.objects.get(account_id=5), 'agent':'PSD Buses', 
                'passenger_number':1, 'passenger_type':'one adult', 'vehicle':Vehicle.objects.get(reference='231635'),
                'route':'fast route', 'travel_from_date_time':'2021-10-27T11:33:11Z', 'travel_to_date_time':'2021-11-08T11:33:11Z',
                'conditions':'peak time', 'concession':'none', 'restrictions':'off peak only',
                'ticket':Ticket.objects.get(reference='1234D'), 'location_from':LocationFrom.objects.get(id=1),
                'location_to':LocationTo.objects.get(id=3), 'reserved_position':'1A', 'service_request':'charging'},    
                ...
                'travel_class':'first', 'booking_date_time':'2021-01-07T11:33:11Z', 'transaction':Transaction.objects.get(reference='432'),
                'account_balance':AccountBalance.objects.get(account_id=2), 'agent':'PSD Buses', 
                'passenger_number':3, 'passenger_type':'two adults, one child', 'vehicle':Vehicle.objects.get(reference='137648'),
                'route':'scenic route', 'travel_from_date_time':'2021-12-07T11:33:11Z', 'travel_to_date_time':'2021-12-08T11:33:11Z',
                'conditions':'peak time', 'concession':'family saving card', 'restrictions':'off peak only',
                'ticket':Ticket.objects.get(reference='1334D'), 'location_from':LocationFrom.objects.get(id=2),
                'location_to':LocationTo.objects.get(id=1), 'reserved_position':'3F', 'service_request':'food'},  
                ...
                'travel_class':'coach', 'booking_date_time':'2020-12-07T11:33:11Z', 'transaction':Transaction.objects.get(reference='432'),
                'account_balance':AccountBalance.objects.get(account_id=6), 'agent':'PSB Buses', 
                'passenger_number':2, 'passenger_type':'two adults', 'vehicle':Vehicle.objects.get(reference='231635'),
                'route':'scenic route', 'travel_from_date_time':'2020-12-07T11:33:11Z', 'travel_to_date_time':'2020-12-08T11:33:11Z',
                'conditions':'peak time', 'concession':'family saving card', 'restrictions':'off peak only',
                'ticket':Ticket.objects.get(reference='1534D'), 'location_from':LocationFrom.objects.get(id=3),
                ...
                'travel_class':'first', 'booking_date_time':'2021-01-07T11:33:11Z', 'transaction':Transaction.objects.get(reference='432'),
                'account_balance':AccountBalance.objects.get(account_id=2), 'agent':'PSD Buses', 
                'passenger_number':3, 'passenger_type':'two adults, one child', 'vehicle':Vehicle.objects.get(reference='231635'),
                'route':'scenic route', 'travel_from_date_time':'2021-12-07T11:33:11Z', 'travel_to_date_time':'2021-12-08T11:33:11Z',
                'conditions':'peak time', 'concession':'family saving card', 'restrictions':'off peak only',
                'ticket':Ticket.objects.get(reference='1334D'), 'location_from':LocationFrom.objects.get(id=2),
                'location_to':LocationTo.objects.get(id=1), 'reserved_position':'3F', 'service_request':'food'}, 
